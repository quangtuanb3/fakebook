!function (t, e) {
            ...
            for (var e = Object(t), i = 1; i < arguments.length; i++) {
                ...
                if (null != s) {
                    ...
                    for (var a = Object.keys(Object(s)), r = 0, n = a.length; r < n; r++) {
                        var o = a[r], h = Object.getOwnPropertyDescriptor(s, o);
    ...
    var t = {}, e = 1, i = function (i, s, a, r) {
        void 0 === r && (r = {}), t["jvm:" + s + "::" + e++] = {selector: i, handler: a}, i.addEventListener(s, a, r)
    }, s = function (e, i, s) {
        var a = i.split(":")[1];
    ...
    var _ = function () {
        ...
        return e.createElement = function (t) {
            ...
            if (b(t)) for (var i in t) this.applyAttr(i, t[i]); else this.applyAttr(t, e)
        }, e.get = function (t) {
        ...
        return i.setStyle = function (t, e) {
            var i;
            b(t) ? w(this.style.current, t) : w(this.style.current, ((i = {})[t] = e, i));
            this.updateStyle()
        }, i.updateStyle = function () {
            var t = {};
            w(t, this.style.initial), w(t, this.style.current), this.isHovered && w(t, this.style.hover), this.isSelected && (w(t, this.style.selected), this.isHovered && w(t, this.style.selectedHover)), this.set(t)
        }, e
    }(_), C = function (t) {
        function e(e, i) {
    ...
    function O(t, e, i) {
        var s = g(e), a = -1 === s.attr("class").indexOf("jvm-region") ? "marker" : "region",
            r = "region" === a ? s.attr("data-code") : s.attr("data-index"), n = a + ":select";
    ...
    var E = function () {
        ...
        return e.getLabelText = function (t, e) {
            ...
            return y(e.offsets) ? e.offsets(t) : S(e.offsets) ? e.offsets[t] : [0, 0]
        ...
        function e(e) {
            var i, s = e.map, a = e.code, r = e.path, n = e.style, o = e.label, h = e.labelStyle, l = e.labelsGroup;
            ...
            var c = i.shape.getBBox(), u = i.getLabelText(a, o);
            if (o && u) {
        ...
        return k(e, t), e.prototype.updateLabelPosition = function () {
    ...
    var T = function (t) {
        function e(e) {
            var i, s = e.index, a = e.map, r = e.style, n = e.x1, o = e.y1, h = e.x2, l = e.y2, c = e.group;
    ...
    var z = function (t) {
        function e(e) {
            var i, s = e.index, a = e.style, r = e.label, n = e.cx, o = e.cy, h = e.map, l = e.group;
        ...
        return i.updateLabelPosition = function () {
            ...
            var e = t.index, i = t.map, s = t.label, a = t.labelsGroup, r = t.cx, n = t.cy, o = t.marker,
                h = t.isRecentlyCreated, l = this.getLabelText(e, s);
            ...
            var t = {};
            return this._isImage ? t.initial = {image: this.config.style.initial.image} : t = this.config.style, t
        }, e
    }(E);
    var P = function () {
        function t(t) {
        ...
        return t.prototype.render = function () {
            var t, e, i, s = this._series.scale.getTicks(), a = m("div", "jvm-legend-inner");
            ...
            for (var n = 0; n < s.length; n++) {
                switch (t = m("div", "jvm-legend-tick"), e = m("div", "jvm-legend-tick-sample"), this._series.config.attribute) {
                    case"fill":
                        f(s[n].value) ? e.style.background = "url(" + s[n].value + ")" : e.style.background = s[n].value;
                        break;
                    case"stroke":
                        e.style.background = s[n].value;
                        break;
                    case"image":
                        e.style.background = "url(" + (b(s[n].value) ? s[n].value.url : s[n].value) + ") no-repeat center center", e.style.backgroundSize = "cover"
                }
        ...
        function t(t, e, i) {
            void 0 === t && (t = {}), this._map = i, this._elements = e, this._values = t.values || {}, this.config = t, this.config.attribute = t.attribute || "fill", t.attributes && this.setAttributes(t.attributes), b(t.scale) && (this.scale = new D(t.scale)), this.config.legend && (this.legend = new P(w({
                map: this._map,
                series: this
    ...
    var H = {
        mill: function (t, e, i) {
            ...
            var s = i * this.radDeg, a = 29.5 * this.radDeg, r = 45.5 * this.radDeg, n = t * this.radDeg,
                o = e * this.radDeg, h = (Math.sin(a) + Math.sin(r)) / 2,
                l = Math.cos(a) * Math.cos(a) + 2 * h * Math.sin(a), c = h * (o - s),
                u = Math.sqrt(l - 2 * h * Math.sin(n)) / h, p = Math.sqrt(l - 2 * h * Math.sin(0)) / h;
            return {x: u * Math.sin(c) * this.radius, y: -(p - u * Math.cos(c)) * this.radius}
        }, lcc: function (t, e, i) {
            var s = i * this.radDeg, a = e * this.radDeg, r = 33 * this.radDeg, n = 45 * this.radDeg,
                o = t * this.radDeg,
            ...
            return {x: c * Math.sin(h * (a - s)) * this.radius, y: -(u - c * Math.cos(h * (a - s))) * this.radius}
        }
    };
    ...
    var G = Object.freeze({
        __proto__: null, handleContainerEvents: function () {
            ...
            this.params.draggable && (this.container.on("mousemove", (function (i) {
                ...
                var s = i.container.selector.getBoundingClientRect(), r = t.pageX - s.left - window.pageXOffset,
            ...
            this.container.delegate(".jvm-element", "mouseover mouseout", (function (e) {
                var i = O(t, this, !0), s = t.params.showTooltip;
            ...
            var t = this, e = this, s = m("div", "jvm-zoom-btn jvm-zoomin", "&#43;", !0),
            ...
            var t, e, i, s, a, r, n, o = this, h = function (h) {
            ...
            var t, e;
            for (t in this.regionLabelsGroup = this.regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"), this.mapData.paths) e = new L({
                map: this,
                code: t,
            ...
            for (var o in this.linesGroup = this.linesGroup || this.canvas.createGroup("jvm-lines-group"), t) {
                ...
                !1 !== r && !1 !== n && (a = new T({
                    index: o,
                    map: this,
                    style: x({initial: this.params.lineStyle}, {initial: h.style || {}}),
                    x1: r.x,
                    y1: r.y,
                    x2: n.x,
                    y2: n.y,
            ...
            for (var o in void 0 === t && (t = {}), void 0 === e && (e = !1), this.markersGroup = this.markersGroup || this.canvas.createGroup("jvm-markers-group"), this.markerLabelsGroup = this.markerLabelsGroup || this.canvas.createGroup("jvm-markers-labels-group"), t) {
                if (i = t[o], a = this.getMarkerPosition(i), r = i.coords.join(":"), e) {
                    if (M(this.markers).filter((function (t) {
                ...
                !1 !== a && (s = new z({
                    ...
                    marker: i,
                    isRecentlyCreated: e
                }), this.markers[o] && this.removeMarkers([o]), this.markers[o] = {_uid: r, config: i, element: s})
            }
        }, createTooltip: function () {
            var t = this, e = this, i = m("div", "jvm-tooltip");
            this.tooltip = g(document.body.appendChild(i)), this.container.on("mousemove", (function (s) {
                if ("block" === e.tooltip.selector.style.display) {
                    var a = t.container.selector.querySelector("#jvm-regions-group").getBoundingClientRect(),
                        r = i.getBoundingClientRect(), n = r.height, o = r.width, h = s.clientY <= a.top + n + 5,
                        l = s.pageY - n - 5, c = s.pageX - o - 5;
                    h && (l += n + 5, c -= 10), s.clientX < a.left + o + 5 && (c = s.pageX + 5 + 2, h && (c += 10)), t.tooltip.css({
                        top: l + "px",
                        left: c + "px"
                    })
                }
            ...
            for (var t in this.series = {
                markers: [],
                regions: []
            }, this.params.series) for (var e = 0; e < this.params.series[t].length; e++) this.series[t][e] = new I(this.params.series[t][e], this[t], this)
            ...
            if (t.coords) {
                var a = this.coordsToPoint(t.coords[0], t.coords[1]), r = this.transX - a.x / this.scale,
            ...
            var r, n, o, h, l, c, u, p, d, f, m = this, g = 0,
            ...
            var i, s, a, r = V.maps[this.params.map].projection, n = r.centralMeridian;
            return i = H[r.type](t, e, n), !!(s = this.getInsetForPoint(i.x, i.y)) && (a = s.bbox, i.x = (i.x - a[0].x) / (a[1].x - a[0].x) * s.width * this.scale, i.y = (i.y - a[0].y) / (a[1].y - a[0].y) * s.height * this.scale, {
                x: i.x + this.transX * this.scale + s.left * this.scale,
                y: i.y + this.transY * this.scale + s.top * this.scale
            })
        }, getInsetForPoint: function (t, e) {
            var i, s, a = V.maps[this.params.map].insets;
            ...
            for (var i in this.lines) {
                ...
                !1 !== t && !1 !== e && this.lines[i].element.setStyle({x1: t.x, y1: t.y, x2: e.x, y2: e.y})
            }
        ...
        return e.init = function (t) {
            ...
            void 0 === i && (i = {}), this.createLines([{from: t, to: e, style: i}], this.markers, !0)
        }, e.reset = function () {
            ...
            var e = this;
            void 0 === t && (t = !0);
            var i = a(), r = this.tooltip.selector, n = Object.keys;
            r.parentElement.removeChild(r), n(i).forEach((function (t) {
    ...
    V.maps = {}, V.defaults = {
        ...
        markerStyle: {
            initial: {
                ...
                strokeWidth: 5,
                strokeOpacity: .5
            }, hover: {fill: "#3cc0ff", cursor: "pointer"}, selected: {fill: "blue"}, selectedHover: {}
        },
        markerLabelStyle: {
            initial: {
                fontFamily: "Verdana",
                ...
                cursor: "default",
                fill: "#374151"
            }, hover: {cursor: "pointer"}, selected: {}, selectedHover: {}
        },
        regionsSelectable: !1,
        regionsSelectableOne: !1,
        regionStyle: {
            initial: {fill: "#dee2e8", fillOpacity: 1, stroke: "none", strokeWidth: 0},
            hover: {fillOpacity: .7, cursor: "pointer"},
