...
@WebServlet(urlPatterns = "/users", name = "profileController")
public class HomeController extends HttpServlet {
    ...
    private void showList(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("post", ProfileService.getProfileService().getProfileList(request)); // gửi qua list users để jsp vẻ lên trang web
