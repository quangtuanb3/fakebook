...
import modals.Content;
import modals.LikeNumber;
import modals.Post;
import modals.Share;
...
public class PostService {
    ...
    static {
        ...
        Post post1 = new Post(++Post.currentId, UserService.currentUser, new Content("No caption"),
        ...
        Post post2 = new Post(++Post.currentId, UserService.currentUser, new Content("No caption"),
                Timestamp.valueOf(LocalDateTime.now()), "Hue", new Share(),
                ELimit.PUBLIC, new ArrayList<>(Arrays.asList("hashTag1", "hashTag2")));
        ...
        Post post3 = new Post(++Post.currentId, UserService.currentUser, new Content("No caption"),
                Timestamp.valueOf(LocalDateTime.now()), "Hue", new Share(),
                ELimit.PUBLIC, new ArrayList<>(Arrays.asList("hashTag1", "hashTag2")));
        ...
        Post post4 = new Post(++Post.currentId, UserService.currentUser, new Content("No caption"),
                Timestamp.valueOf(LocalDateTime.now()), "Hue", new Share(),
                ELimit.PUBLIC, new ArrayList<>(Arrays.asList("hashTag1", "hashTag2")));
    ...
    public List<Post> findAll() {
        return postList.stream().filter(e -> Objects.equals(e.getUser(), UserService.currentUser)).collect(Collectors.toList());
    }
